...
// ADD NEW ITEM START OF LIST (+3)
var newItemFirst = document.createElement('li');                   // Create element
var newTextFirst = document.createTextNode('Perform regular maintenance on the rock wall');                // Create text node
...
var listItems = document.getElementsByClassName('hot');                 // All <li> elements
...
var heading = document.querySelector('h4');                        // h2 element
